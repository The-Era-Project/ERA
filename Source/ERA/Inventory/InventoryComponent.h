...
class ERA_API UInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	static FGameplayTag EquipNextItemActorTag;
	static FGameplayTag DropItemActorTag;
	static FGameplayTag UnequipItemActorTag;
